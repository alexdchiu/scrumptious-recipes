...
class Recipe(models.Model):
    ...
    edited_by = models.ForeignKey(USER_MODEL,related_name="edited_recipes", on_delete=models.CASCADE, null=True)
...
class Ingredient(models.Model):
    amount = models.FloatField(validators=[MinValueValidator(0.0), MaxValueValidator(15.0)])
    ...
    def __str__(self):
        return str(self.amount) + " " + str(self.measure) + " " + str(self.food) + " (" + str(self.recipe) + ")"
